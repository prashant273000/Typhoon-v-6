...
module.exports = async (client, message, args, type) => {
  ...
  if (!permissions.has("CONNECT"))
    return message.channel.send(new MessageEmbed()
      ...
      .setTitle("<a:error:843768213308178462> Error | I need permissions to join your channel !")
    );
  if (!permissions.has("SPEAK"))
    return message.channel.send(new MessageEmbed()
      .setColor(ee.wrongcolor)
      .setFooter(ee.footertext, ee.footericon)
      .setTitle("<a:error:843768213308178462> Error | I need permissions to speak in your channel !")
    );
  ...
  require("./playermanagers/skiptrack")(client, message, args, type); 
    ...
    return message.channel.send(new MessageEmbed()
      .setColor(ee.wrongcolor)
      .setFooter(ee.footertext, ee.footericon)
      .setTitle("<a:error:843768213308178462> Error | No valid search Term? ... Please Contact: `PRASHANT`")
    );
}