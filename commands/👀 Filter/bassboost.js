...
module.exports = {
  ...
  category: `👀 Filter`,
  aliases: [`bb`],
  description: `Changes the bassboost level !`,
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    try {
      ...
      return message.channel.send(new MessageEmbed()
        .setColor("#00FFC1")
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(`${emoji.msg.SUCCESS} Success | Set the bassboost to \`${level}\``)
        .setDescription(`Note: *It might take upto some time about 2-5 seconds until you hear bassboost.*`)
      );
    } catch (e) {
