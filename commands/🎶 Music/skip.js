    ...
    try{
      ...
      if (!channel)
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle("<a:error:843768213308178462> Error | You need to join a voice channel.")
        );
      ...
      if (channel.id !== player.voiceChannel)
        return message.channel.send(new MessageEmbed()
          .setFooter(ee.footertext, ee.footericon)
          .setColor(ee.wrongcolor)
          .setTitle("<a:error:843768213308178462> Error | Please be in my voice channel!")
      ...
      return message.channel.send(new MessageEmbed()
        .setTitle("<a:load:843777570884550686> Success | <a:red_271:839493730981773332>  Skipped to the next Song")
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
      );
    } catch (e) {
        ...
        return message.channel.send(new MessageEmbed()
            .setColor(ee.wrongcolor)
						.setFooter(ee.footertext, ee.footericon)
            .setTitle(`<a:error:843768213308178462> ERROR | An error occurred`)
...
/**
  * @INFO
  * Bot Coded by Tomato#6966 | https://github.com/Tomato6966/discord-js-Typhoonlink-Music-Bot-erela-js
  * @INFO
