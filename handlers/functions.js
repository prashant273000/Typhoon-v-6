  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("Typhoon Music System| Music Queue")
      ...
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("Typhoon Music System| Currently no song is playing!")
        .setDescription(`Join a voice channel and enter a song name or url to play.\n\n[Invite Typhoon Bot](https://bit.ly/typhoonbot) • [Support Server](https://discord.gg/WHdzfr9QE4)`)
        .setImage("https://cdn.discordapp.com/attachments/830721752564105216/840969161953640458/1b4bfada7ea35b721432ae156a0fc7e2.jpg")
    ...
    function SongEmbed(track) {
      ...
      let embed = new MessageEmbed()
        ...
        embed.setTitle(`<a:load:843777570884550686> Progress:`)
        embed.setDescription(`${createBarlul(player)}`)
        embed.addField("<a:online:843823055432318976> **Song By:**", `\`${track.author}\``, true)
        embed.addField(`<a:online:843823055432318976> **State**`, `\`${player.playing ? `${emoji.msg.resume}  Playing` : `${emoji.msg.pause}  Paused`}\``, true)
        embed.addField(`<a:load:843777570884550686> **Requested by:**`, `${track.requester}`, true)
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`Typhoon Music System | Music Queue`);
      const multiple = 15;
      const page = 1;
   ...
   embed.setColor(ee.color);
      embed.setImage("https://cdn.discordapp.com/attachments/830721752564105216/840969161953640458/1b4bfada7ea35b721432ae156a0fc7e2.jpg");
      embed.setFooter(ee.footertext, ee.footericon);
      return embed;
    }
    function format(millis) {
