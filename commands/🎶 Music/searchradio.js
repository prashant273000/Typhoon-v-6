        ...
        .then(async data => {
          ...
          try {
            ...
            return message.channel.send(new MessageEmbed()
              .setTitle("<a:error:843768213308178462> Error | You didn't provide a selection")
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
            );
          }
          ...
          if (first.toLowerCase() === 'end') {
            ...
            return message.channel.send(new MessageEmbed()
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle('<a:error:843768213308178462> Error | Selection cancled.')
            );
          }
          ...
          if (isNaN(index))
            return message.channel.send(new MessageEmbed()
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`<a:error:843768213308178462> Error | Please provide right numbed within (1-${counter}).`)
            );
          if (index < 0 || index > counter - 1)
            return message.channel.send(new MessageEmbed()
              .setColor(ee.wrongcolor)
              .setFooter(ee.footertext, ee.footericon)
              .setTitle(`<a:error:843768213308178462> Error | Please provide a number not too small nor big (1-${counter}).`)
            );
