...
module.exports = {
  ...
  .setFooter(`Requested by: ${player.queue.current.requester.tag} | in: ${message.guild.name}`, player.queue.current.requester.displayAvatarURL({
    dynamic: true
      ...
      return message.channel.send("**<a:error:843768213308178462> Your DM is disabled**")
    })    

    message.react(emoji.react.SUCCESS).catch(e=>console.log(" <a:error:843768213308178462> Could not add reaction to the message !"))
  }
};