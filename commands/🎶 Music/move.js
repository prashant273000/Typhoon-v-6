    ...
    try{
      ...
      if (!args[0])
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`${emoji.msg.ERROR} | YOu used the command wrongly!`)
      ...
      return message.channel.send(new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle(`${emoji.msg.SUCCESS} Success | Moved the Song in the Queue from Position \`${args[0]}\` to Position: \`${args[1]}\``)
