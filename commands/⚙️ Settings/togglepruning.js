...
module.exports = {
  ...
  category: "⚙️ Settings",
  description: "Toggles pruning. If its true a message of playing a new track will be sent. If false it wont send any message if a new Track plays. DEFAULT:TRUE.",
  usage: "togglepruning",
